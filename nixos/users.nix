  ...
  users.users = {
    ${username} = {
      ...
      openssh.authorizedKeys.keys = [
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAID7uig8Y3y7H46psoW3iOGhPdlTAN5fHsgpgoQkSLtU6 Emil Fresk (gitlab.com)"
        ...
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIF8clWkc/uvmqQ3u+5oYntRq1Bv5J2o9FxS1L9lHBE9+ Emil Fresk (gitlab.com)"
